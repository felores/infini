...
const tabs = [
  { title: 'Overview', href: '/docs/overview/quick-start', prefix: '/docs/overview' },
  { title: 'User Guide', href: '/docs/canvas/canvas-node-manual', prefix: '/docs/canvas' },
  { title: 'Development', href: '/docs/development/local-development', prefix: '/docs/development' },
  { title: 'Progress', href: '/docs/progress/changelog', prefix: '/docs/progress' },
  { title: 'Business', href: '/docs/business/business', prefix: '/docs/business' },
  { title: 'Support', href: '/docs/support/donate', prefix: '/docs/support' },
];
